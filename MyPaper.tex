...
It uses a neural network model, more specifically, a recurrent deep neural network (RNN) that takes a sequence of program tokens and predicts the next token.  It can be understood as an application of the RNN-based sentence generation for natural lnaguages.%RNNs are known to be successful in the domain of natural language texts. 
